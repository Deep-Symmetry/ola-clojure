...
(defn generate-file
  ...
  (let [lc-name (clojure.string/lower-case class-name)
        dest (file "generated" "ola_clojure" (str lc-name "_" file-type ".clj"))]
    (.mkdirs (.getParentFile dest))
    (spit dest (render-file (str "ola_clojure/" file-type "_template.clj") context))))
